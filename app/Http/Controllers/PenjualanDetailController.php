...
class PenjualanDetailController extends Controller
{
    public function index()
    {
        ...
        } else { //kalau gak ada trasaksi berjalan di cek
    ...
    public function data($id) //id di ambil data route transaski {id}
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['aksi']        = '<div class="btn btn-group">
                                <button type="button" onclick="deleteData(`' . route('transaksi.destroy', $item->id_penjualan_detail) . '`)" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                                </div>';
            $data[]             = $row;
